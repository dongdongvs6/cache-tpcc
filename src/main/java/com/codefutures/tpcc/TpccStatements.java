...
public class TpccStatements {
    ...
    public TpccStatements(Connection conn, int fetchSize) throws Exception {
        ...
        pStmts[8]  = prepareStatement("INSERT %NOLOCK INTO order_line (ol_o_id, ol_d_id, ol_w_id, ol_number, ol_i_id, ol_supply_w_id, ol_quantity, ol_amount, ol_dist_info) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
